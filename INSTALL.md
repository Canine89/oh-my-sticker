...
[Releases](https://github.com/Canine89/oh-my-sticker/releases)에서 최신 `oh-my-sticker-<버전>.dmg`를 내려받습니다.

## 설치

1. 받은 DMG를 엽니다.
2. `oh-my-sticker` 앱을 `Applications` 폴더로 끌어다 놓습니다.
3. 앱을 실행합니다.
